$(document).ready(function () {
	var opensubmenu = $("#menu").find(".active").attr("opensubmenu")
	var windowheight2 = $("#" + opensubmenu).height() + 50
	$("#" + opensubmenu).show()
	$("#menu").animate({
	...
	$("#menu .nav li").mouseover(function () {
		...
		$(".submenu").hide();
		opensubmenu = $(this).attr("opensubmenu")
		var windowheight = $("#" + opensubmenu).height() + 50
		$("#" + opensubmenu).show();
	...
	// 选项卡
	$('#RankingTab li').each(function (index) {
		if (!$(this).is(".active")) {
			$("#RankingTab").parent().find(".Tab_nr:eq(" + index + ")").hide();
		}
		$(this).mouseover(function () {
			$('#RankingTab li').removeClass('active');
			$(this).addClass('active');
			$("#RankingTab").parent().find(".Tab_nr").hide();
			$("#RankingTab").parent().find(".Tab_nr:eq(" + index + ")").show();
		})
	})
	if ($("#KinSlideshow").length > 0) {
		$("#KinSlideshow").KinSlideshow({
			...
			btn: {
				btn_bgColor: "#3886c5",
				btn_bgHoverColor: "#fff",
				btn_fontColor: "#fff",
				btn_fontHoverColor: "#000",
				btn_borderColor: "#ff0099",
				btn_borderHoverColor: "#eb83af",
				btn_borderWidth: 0,
				btn_bgAlpha: 1
			}
		});
